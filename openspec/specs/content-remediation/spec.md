# Content Remediation Specification

## Purpose

Capture the content remediation patterns applied during the language consistency pass: navigation label corrections, accent fixes, glossary-driven term standardization, and the no-functional-regression constraint.
...
#### Scenario: Article 3 title is validated as already correct
...
All English terms embedded in Spanish sentences across the affected files SHALL follow the resolved glossary from the Language Convention specification (R3). Specifically:
...
#### Scenario: "set flagship" is glossary-compliant
