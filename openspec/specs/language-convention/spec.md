# Language Convention Specification

## Purpose

Codify the site-wide language rule — brand/technical terms stay in English, all other content is in Spanish. Defines the glossary of permitted EN-in-ES terms and a decision procedure for new content.
