export const personal = {
  name: "Juan Fontalvo",
  job: "Arquitecto de software / Ingeniero IA",
  bio: "Arquitecto de software e ingeniero IA enfocado en automatización operativa, workflows de WhatsApp, handoff humano y memoria persistente para equipos que necesitan convertir procesos reales en sistemas confiables.",
  country: "Colombia",
  city: "Bogotá",
  phone: "3128670860",
